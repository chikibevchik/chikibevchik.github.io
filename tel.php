...
<h1 align="center"><font color="green">Телефонний довідник</font></h1>
    <form action="tel09.php" method="post">
        ...
        <tr>
            <td><font color="green">Телефон</font> : </td>
            <td><input type="text" size="10" maxlength="20" name="ntel"></td>
            </tr>
            <tr>
            <td><font color="green">Номер вулиці</font> : </td>
            <td><input type="text" size="10" maxlength="20" name="nvul"></td>
            </tr>
            <tr>
                <td><font color="green">Буд</font> : </td>
